...
const menuRouter: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			},
			{
				...
				name: "menu221",
				component: () => import("@/pages/menu/menu2/menu22/menu221/index.vue"),
				meta: {
					keepAlive: true,
					requiresAuth: true,
					title: "菜单2-2-1",
			...
			},
			{
				...
				name: "menu222",
				component: () => import("@/pages/menu/menu2/menu22/menu222/index.vue"),
				meta: {
					keepAlive: true,
					requiresAuth: true,
					title: "菜单2-2-2",
			...
			},
			{
				...
				name: "menu23",
				component: () => import("@/pages/menu/menu2/menu23/index.vue"),
				meta: {
					keepAlive: true,
					requiresAuth: true,
					title: "菜单2-3",
